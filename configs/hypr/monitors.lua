...
hl.workspace_rule({ workspace = "3", monitor = "DP-2", persistent = true, layout = "scrolling" })
hl.workspace_rule({ workspace = "4", monitor = "DP-2", persistent = true, layout = "scrolling" })
hl.workspace_rule({ workspace = "5", monitor = "HDMI-A-1", persistent = true, layout = "scrolling" })
hl.workspace_rule({ workspace = "6", monitor = "HDMI-A-1", persistent = true, layout = "scrolling" })
