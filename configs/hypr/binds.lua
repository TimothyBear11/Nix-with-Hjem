...
local noctLauncher = noct .. " panel-toggle launcher"
local noctCC = noct .. " panel-toggle control-center"
...
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("/home/tbear/nix/scripts/media-hub.sh"))
